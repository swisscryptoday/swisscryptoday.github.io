...
|  11:00-11:30 || **Guillaume Endignoux (Google)** <details close>Guillaume Endignoux is a software engineer and cryptographer at Google, where he’s working on deploying the newly standardized post-quantum cryptographic algorithms to practical systems. During his studies, he co-designed the Gravity-SPHINCS proposal to NIST’s PQC competition, a hash-based signature scheme of the same family as the recently standardized SLH-DSA algorithm. Guillaume is also a convinced enthusiast of the Rust programming language, because of how it combines software correctness and performance optimizations.</details> |
